...
urlpatterns = [
    ...
    path('teachers/groups/<str:group_id>/subject/<int:subject_id>/', TeacherGroupDiciplinesListView.as_view()),
    path('teachers/groups/<str:group_id>/subject/<int:subject_id>/<int:student_id>', TeacherStudentView.as_view()),
